...
```
where "url you just copied" (without the quote marks) is the url to this repository (your fork of this project). refer the previous steps in order to obtain the url.
